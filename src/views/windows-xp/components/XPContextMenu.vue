...
onMounted(() => {
  if (menuRef.value) {
    ...
    if (props.y + rect.height > window.innerHeight - 40) {
      // 40px for taskbar
...
<template>
  ...
  >
    <div
      class="flex items-center px-4 py-1 hover:bg-[#316ac5] hover:text-white group"
